...
class ClientFactory
{
    ...
    private static $defaultProxyHost;
    private static $defaultProxyPort;
    ...
    /*
     * Create a service client instance of Word Translation.. nkjm.
     */
    public static function createDocumentTranslationClient($url)
    {
        return self::setup(new DocumentTranslationClientImpl($url));
    }
    ...
    */
    ...
    public static function setProxy($proxyHost, $proxyPort)
    {
        self::$defaultProxyHost = $proxyHost;
        self::$defaultProxyPort = $proxyPort;
    }
    ...
    private static function  setup(ServiceClient $serviceClient)
    {
        ...
        if (self::$defaultProxyHost && self::$defaultProxyPort) {
            $serviceClient->setProxy(self::$defaultProxyHost, self::$defaultProxyPort);
        }
